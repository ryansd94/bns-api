...
{
    public class UpdateJM_IssueCommand
    {
       
        public class UpdateJM_IssueCommandHandler : IRequestHandler<UpdateJM_IssueRequest, ApiResult<Guid>>
        {
            protected readonly BNSDbContext _context;
            protected readonly IStringLocalizer<SharedResource> _sharedLocalizer;

            public UpdateJM_IssueCommandHandler(BNSDbContext context,
